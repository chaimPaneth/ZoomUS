#
#  Be sure to run `pod spec lint ZoomUS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Chaim Paneth" => "chaim@chaimpaneth.com" }

  spec.swift_version              = "5.0"
  spec.ios.deployment_target      = "10.0"

  spec.source       = { :git => "https://github.com/chaimPaneth/ZoomUS.git", :tag => "v#{spec.version}" }
